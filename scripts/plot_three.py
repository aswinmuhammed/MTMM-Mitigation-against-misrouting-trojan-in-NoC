...
plt.plot(injection_rates, latencies, marker='o', label='Normal NOC (uniform_random)', color='blue')

# Plot the effective packet latencies (HT)
plt.plot(injection_rates, ht_latencies, marker='s', label='HT NOC (uniform_random)', color='red')

# Plot the mitigation latencies
plt.plot(injection_rates, mitigation_latencies, marker='^', label='Mitigation NOC (uniform_random)', color='green')

...
# Configure the graph
plt.title('Average Packet Latency vs. Injection Rate (Uniform Random)')
...
plt.ylim(15, 50)  # Set y-axis limits to match reference
plt.yticks(range(15, 51, 5))  # Adjust y-axis ticks with intervals of 5
